...
class EditExamDetails extends StatefulWidget {
  @override
  _EditExamDetailsState createState() => _EditExamDetailsState();
}

class _EditExamDetailsState extends State<EditExamDetails> {
...
class ExamsToDelete extends StatefulWidget {
  String sem;
  String dept;
  ExamsToDelete({
    this.dept,
  ...
  @override
  _ExamsToDeleteState createState() => _ExamsToDeleteState();
}

class _ExamsToDeleteState extends State<ExamsToDelete> {
  final _scaffoldKey = GlobalKey<ScaffoldState>();
